        ...
        <div className=' flex justify-around items-center font-inter py-2 lg:py-3 px-2 lg:px-24 shadow-black shadow-xl drop-shadow-[4px] poppins-regular w-[100%]'>
            ...
            <div className='flex gap-5 relative'>
                ...
                <div className=' justify-center items-center gap-1 hidden lg:flex cursor-pointer' onClick={() => handleDropdownClick('explore')}  ref={dropdownMenuRef}>
                    <div><img className='w-5 ' src={Explore} alt="Explore" /></div>
                    <div>Explore</div>
                ...
                <div className='  justify-center items-center gap-1 hidden lg:flex cursor-pointer'>
                    <div><img src={Hobbies} alt="Hobbies" /></div>
                    <div>Hobbies</div>
                    <div><img src={Arrow} alt="" /></div>
                </div>
            </div>
            <div className='flex gap-3 ml-8'>
                <img src={Bookmark} alt="Bookmark" className='cursor-pointer hover:scale-90 hidden lg:block' />
                <img src={Search} alt="Bookmark" className='cursor-pointer hover:scale-90 block lg:hidden' />
                <img src={Notification} alt="Notification" className='cursor-pointer hover:scale-90' />
                <img src={Cart} alt="Cart" className='cursor-pointer hover:scale-90 hidden lg:block' />
                <div className='relative' ref={dropdownMenuRef}>
                <img src={Line} alt="Cart" className='cursor-pointer hover:scale-90 block lg:hidden' onClick={() => handleDropdownClick('lines')}/>
                {islines &&
