...
import FootPersons from '../../images/FootPersons.png'
...
const Home = () => {
    ...
    return (
        <div>
            <Navbar />
            <img src={Top} alt="Top" className='fixed right-0 bottom-3 drop-shadow-md z-20' onClick={handleTop} />
            <div className='w-[100%] h-[100%] bg-purple-50 px-4 lg:px-32 pt-8 lg:pt-24  flex flex-col lg:flex-row'>
                <div className='w-[100%] lg:w-[65%]'>
                    <div className='text-xl lg:text-4xl poppins-semibold-italic px-2'>
                    ...
                    <div className='w-[100%] mt-[121px] hidden lg:block'>
                        <img src={Humans} alt="Humans" className='w-[80%]' />
                    </div>
                </div>
                {isSignIn &&
                ...
                <div className='w-[100%] mt-16 block lg:hidden'>
                    <img src={Humans} alt="Humans" className='w-[100%]' />
                </div>
            </div>
            ...
            <div className='w-[100%] bg-blue-50 px-4 lg:px-32 py-16 lg:py-24'>
                <Card Image={Add} Heading="Add your own" Para="Are you a teacher or expert? Do you sell or rent out equipment, venue or event tickets? Or, you know someone who should be on hobbycue? Go ahead and Add your Own page" Button="Add New" Width='w-[100%]' BG='bg-white' IconWidth='w-7' />
            </div>
            ...
            <div className='w-[100%] px-4 lg:px-32 py-16 lg:py-24'>
                ...
                <div className={`card border bg-purple-50 border-gray-500 rounded-md w-[100%] p-10 gap-10 flex flex-col h-[100%] m-auto`}>
                    <div className='flex gap-2'>
                        <img className='w-6 h-6' src={quote} alt="People" />
                        <div className='font-bold text-xl poppins-semibold'>Testimonials</div>
                    </div>
                    ...
                    <div className='w-[100%] flex flex-col-reverse lg:flex-row justify-between items-center gap-5 lg:gap-0'>
                        <div className='w-[100%] lg:w-[50%] bg-purple-300 rounded-md flex justify-center gap-3 lg:gap-8 items-center h-16'>
                            ...
                            <div className='relative'>
                                <img src={Dp} alt="Dp" className='w-9' />
                                <img src={Mic} alt="Mic" className='absolute w-5 z-10 bottom-[0px] left-[-7px]' />
                            </div>
                        </div>
                        <div className='flex justify-center items-center gap-3'>
                            <div>
                                <img src={Dp} alt="DP" className='w-12' />
                            </div>
                            <div>
                                <div className='font-semibold text-purple-600 poppins-semibold'>Shubha Nagarajan</div>
            ...
            <div className='w-[100%] bg-blue-50 px-4 lg:px-32 pt-16 lg:pt-24 pb-8 lg:pb-24'>
                <div className='text-xl lg:text-4xl poppins-semibold-italic'>
                    <h1>Explore Your <span className='text-blue-500'>Hobby</span> Or <span className='text-purple-600'>Passion</span></h1>
                </div>
                ...
                <div className='w-[100%] mt-10'>
                    <img src={FootPersons} alt="Footer" className='w-[100%]' />
                </div>
            </div>
            <div className="flex flex-col lg:flex-row justify-between items-start bg-white  w-[100%] px-4 lg:px-32 py-16 lg:py-24 gap-12 lg:gap-0">
                <div className='flex flex-col gap-2 w-[100%] lg:w-auto'>
                    <div className='flex justify-between font-semibold mb-2 lg:mb-4 poppins-semibold ' onClick={handleHobbie}><div>HobbieCue</div> <img src={isHobbie ? UpArrow : Arrow} alt="" className='block lg:hidden w-6' /></div>
                    {isHobbie &&
                ...
                <div className='flex flex-col gap-2 w-[100%] lg:w-auto'>
                    <div className='flex justify-between font-semibold mb-2 lg:mb-4 poppins-semibold ' onClick={handleHowDoI}><div>How Do I</div> <img src={isHowDoI ? UpArrow : Arrow} alt="" className='block lg:hidden w-6' /></div>
                    {isHowDoI &&
                        <ul className='flex flex-col gap-2'>
                ...
                <div className='flex flex-col gap-2 w-[100%] lg:w-auto'>
                    <div className='flex justify-between font-semibold mb-2 lg:mb-4 poppins-semibold ' onClick={handleQuick}><div>Quick Links</div> <img src={isQuick ? UpArrow : Arrow} alt="" className='block lg:hidden w-6' /></div>
                    {isQuick &&
                        <ul className='flex flex-col gap-2'>
                ...
                <div>
                    <div className='font-semibold mb-2 lg:mb-4 poppins-semibold'>Social Media</div>
                    <ul className='flex gap-5 lg:gap-3 mb-8'>
                        <li><a href="#facebook"><img src={FB} alt="FB" className='w-7 lg:w-5 cursor-pointer poppins-regular' /></a></li>
                        <li><a href="#twitter"><img src={Twitter} alt="Twitter" className='w-7 lg:w-5 cursor-pointer poppins-regular' /></a></li>
                        <li><a href="#instagram"><img src={Insta} alt="Insta" className='w-7 lg:w-5 cursor-pointer poppins-regular' /></a></li>
                        <li><a href="#pinterest"><img src={P} alt="P" className='w-7 lg:w-5 cursor-pointer poppins-regular' /></a></li>
                        <li><a href="#google"><img src={GoogleIcon} alt="Google" className='w-7 lg:w-5 cursor-pointer poppins-regular' /></a></li>
                        <li><a href="#youtube"><img src={Yt} alt="Yt" className='w-7 lg:w-5 cursor-pointer poppins-regular' /></a></li>
                        <li><a href="#telegram"><img src={Tele} alt="Tele" className='w-7 lg:w-5 cursor-pointer poppins-regular' /></a></li>
                        <li><a href="#email"><img src={Mail} alt="Mail" className='w-7 lg:w-5 cursor-pointer poppins-regular' /></a></li>
                    </ul>
                    <div>
                        <div className='font-semibold mb-2 lg:mb-4 poppins-semibold'>Invite Friends</div>
